...
function resolveGatewayPort(cfg: AiraBotConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: AiraBotConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.AIRABOT_GATEWAY_PASSWORD?.trim() ||
