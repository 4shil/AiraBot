...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@airabot", { botUsername: "airabot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@airabot args", {
        botUsername: "airabot",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "airabot" })).toBe(
      "/help@otherbot",
    );
  });
