...
function resolveMentionPatterns(cfg: AiraBotConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: AiraBotConfig | undefined, agentId?: string): RegExp[] {
