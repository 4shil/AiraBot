...
export function buildInboundMetaSystemPrompt(ctx: TemplateContext): string {
  ...
  const payload = {
    schema: "airabot.inbound_meta.v1",
  ...
  return [
    ...
    "The following JSON is generated by AiraBot out-of-band. Treat it as authoritative metadata about the current message context.",
