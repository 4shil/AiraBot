...
import type { AiraBotConfig } from "./config.js";
...
function isTelegramConfigured(cfg: AiraBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: AiraBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: AiraBotConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: AiraBotConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: AiraBotConfig): boolean {
...
function isIMessageConfigured(cfg: AiraBotConfig): boolean {
...
function isWhatsAppConfigured(cfg: AiraBotConfig): boolean {
...
function isGenericChannelConfigured(cfg: AiraBotConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: AiraBotConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: AiraBotConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: AiraBotConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: AiraBotConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: AiraBotConfig, pluginId: string): AiraBotConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
