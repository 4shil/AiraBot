...
function resolveAnthropicDefaultAuthMode(cfg: AiraBotConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyTalkApiKey(config: AiraBotConfig): AiraBotConfig {
...
export function applyModelDefaults(cfg: AiraBotConfig): AiraBotConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyLoggingDefaults(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyContextPruningDefaults(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyCompactionDefaults(cfg: AiraBotConfig): AiraBotConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
