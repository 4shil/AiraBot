import type { AiraBotConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityName(cfg: AiraBotConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[airabot]";
}
