...
function resolveWatchPaths(workspaceDir: string, config?: AiraBotConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: AiraBotConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: AiraBotConfig }) {
