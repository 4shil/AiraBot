...
describe("createAiraBotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createAiraBotCodingTools({
      config,
    ...
    const anthropicTools = createAiraBotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createAiraBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createAiraBotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
