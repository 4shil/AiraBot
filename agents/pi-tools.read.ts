...
function resolveAdaptiveReadMaxBytes(options?: AiraBotReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createAiraBotReadTool(base, {
...
export function createAiraBotReadTool(
  base: AnyAgentTool,
  options?: AiraBotReadToolOptions,
): AnyAgentTool {
