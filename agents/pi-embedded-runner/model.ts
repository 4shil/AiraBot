...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveAiraBotAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/airabot/airabot/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "airabot configure". ' +
    "See: https://docs.airabot.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "airabot configure". ' +
    "See: https://docs.airabot.ai/providers/vllm",
};
