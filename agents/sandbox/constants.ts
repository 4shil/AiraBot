...
export const DEFAULT_SANDBOX_IMAGE = "airabot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "airabot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "airabot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "airabot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "airabot-sbx-browser-";
