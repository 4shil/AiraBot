...
const CLEANUP_STATE_KEY = Symbol.for("airabot.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("airabot.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("airabot.sessionWriteLockWatchdogState");
