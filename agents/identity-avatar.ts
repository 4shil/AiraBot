...
function resolveAvatarSource(cfg: AiraBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: AiraBotConfig, agentId: string): AgentAvatarResolution {
