...
function listConfiguredAccountIds(cfg: AiraBotConfig): string[] {
...
export function listTelegramAccountIds(cfg: AiraBotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: AiraBotConfig): string {
...
function mergeTelegramAccountConfig(cfg: AiraBotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: AiraBotConfig): ResolvedTelegramAccount[] {
