...
import type { AiraBotConfig, ReplyToMode, TelegramAccountConfig } from "../config/types.js";
...
async function resolveStickerVisionSupport(cfg: AiraBotConfig, agentId: string) {
  try {
