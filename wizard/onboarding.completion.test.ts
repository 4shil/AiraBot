...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("airabot");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "airabot");
