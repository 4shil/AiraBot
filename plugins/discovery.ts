...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @airabot/voice-call -> voice-call).
...
export function discoverAiraBotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".airabot", "extensions")];
