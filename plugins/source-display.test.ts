...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/airabot/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/airabot/extensions",
        global: "/Users/x/.airabot/extensions",
        workspace: "/Users/x/ws/.airabot/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.airabot/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/airabot/extensions",
        global: "/Users/x/.airabot/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.airabot/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/airabot/extensions",
        global: "/Users/x/.airabot/extensions",
