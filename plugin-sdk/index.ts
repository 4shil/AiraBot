...
export type { AiraBotConfig } from "../config/config.js";
/** @deprecated Use AiraBotConfig instead */
export type { AiraBotConfig as ClawdbotConfig } from "../config/config.js";
