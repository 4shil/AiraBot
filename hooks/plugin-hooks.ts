...
import type { AiraBotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: AiraBotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: AiraBotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
