...
// Prefix for AiraBot-generated action IDs to scope our handler
const AIRABOT_ACTION_PREFIX = "airabot:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle AiraBot modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${AIRABOT_ACTION_PREFIX}`),
