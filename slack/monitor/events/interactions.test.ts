          ...
          blocks: [
            {
              ...
              elements: [{ type: "button", action_id: "airabot:verify" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              ...
              elements: [{ type: "multi_static_select", action_id: "airabot:multi" }],
            },
          ],
        },
      },
          ...
          blocks: [
            {
              type: "actions",
              block_id: "date_block",
              elements: [{ type: "datepicker", action_id: "airabot:date" }],
            },
            {
              type: "actions",
              block_id: "time_block",
              elements: [{ type: "timepicker", action_id: "airabot:time" }],
            },
            {
              type: "actions",
              block_id: "datetime_block",
              elements: [{ type: "datetimepicker", action_id: "airabot:datetime" }],
            },
          ],
        },
      },
  ...
  it("captures modal submissions and enqueues view submission event", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V123",
          callback_id: "airabot:deploy_form",
          root_view_id: "VROOT",
    ...
    expect(payload).toMatchObject({
      ...
      actionId: "view:airabot:deploy_form",
      callbackId: "airabot:deploy_form",
      viewId: "V123",
      userId: "U777",
  ...
  it("captures modal input labels and picker values across block types", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V400",
          callback_id: "airabot:routing_form",
          state: {
            values: {
              env_block: {
                env_select: {
              ...
              email_block: {
                email_input: {
                  ...
                  value: "team@airabot.ai",
                },
              },
              url_block: {
                url_input: {
                  type: "url_text_input",
                  value: "https://docs.airabot.ai",
                },
              },
              richtext_block: {
                richtext_input: {
    ...
    expect(payload.inputs).toEqual(
      expect.arrayContaining([
        ...
        expect.objectContaining({
          ...
          inputKind: "email",
          inputEmail: "team@airabot.ai",
        }),
        expect.objectContaining({
          actionId: "url_input",
          inputKind: "url",
          inputUrl: "https://docs.airabot.ai/",
        }),
        expect.objectContaining({
  ...
  it("truncates rich text preview to keep payload summaries compact", async () => {
    ...
    await viewHandler!({
      ...
      body: {
        ...
        view: {
          id: "V555",
          callback_id: "airabot:long_richtext",
          state: {
            values: {
              richtext_block: {
                richtext_input: {
