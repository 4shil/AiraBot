...
function mergeSlackAccountConfig(cfg: AiraBotConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: AiraBotConfig): ResolvedSlackAccount[] {
