...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.AIRABOT_STATE_DIR;
  const configPath = env.AIRABOT_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    AIRABOT_PROFILE: profile,
    AIRABOT_STATE_DIR: stateDir,
    AIRABOT_CONFIG_PATH: configPath,
    AIRABOT_GATEWAY_PORT: String(port),
    AIRABOT_GATEWAY_TOKEN: token,
    AIRABOT_LAUNCHD_LABEL: resolvedLaunchdLabel,
    AIRABOT_SYSTEMD_UNIT: systemdUnit,
    AIRABOT_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    AIRABOT_SERVICE_KIND: GATEWAY_SERVICE_KIND,
    AIRABOT_SERVICE_VERSION: VERSION,
  };
}
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    AIRABOT_STATE_DIR: stateDir,
    AIRABOT_CONFIG_PATH: configPath,
    AIRABOT_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    AIRABOT_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    AIRABOT_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    AIRABOT_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    AIRABOT_LOG_PREFIX: "node",
    AIRABOT_SERVICE_MARKER: NODE_SERVICE_MARKER,
    AIRABOT_SERVICE_KIND: NODE_SERVICE_KIND,
    AIRABOT_SERVICE_VERSION: VERSION,
  };
}
