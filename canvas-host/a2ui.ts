...
export const A2UI_PATH = "/__airabot__/a2ui";

export const CANVAS_HOST_PATH = "/__airabot__/canvas";

export const CANVAS_WS_PATH = "/__airabot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.airabotCanvasA2UIAction.postMessage(...)
  // - Android: window.airabotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["airabotCanvasA2UIAction"];
  ...
  globalThis.AiraBot = globalThis.AiraBot ?? {};
  globalThis.AiraBot.postMessage = postToNode;
  globalThis.AiraBot.sendUserAction = sendUserAction;
  globalThis.airabotPostMessage = postToNode;
  globalThis.airabotSendUserAction = sendUserAction;
