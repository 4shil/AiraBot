...
const SANDBOX_EXAMPLES = {
  main: [
    ["airabot sandbox list", "List all sandbox containers."],
    ["airabot sandbox list --browser", "List only browser containers."],
    ["airabot sandbox recreate --all", "Recreate all containers."],
    ["airabot sandbox recreate --session main", "Recreate a specific session."],
    ["airabot sandbox recreate --agent mybot", "Recreate agent containers."],
    ["airabot sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["airabot sandbox list", "List all sandbox containers."],
    ["airabot sandbox list --browser", "List only browser containers."],
    ["airabot sandbox list --json", "JSON output."],
  ],
  recreate: [
    ["airabot sandbox recreate --all", "Recreate all containers."],
    ["airabot sandbox recreate --session main", "Recreate a specific session."],
    ["airabot sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["airabot sandbox recreate --browser --all", "Recreate only browser containers."],
    ["airabot sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["airabot sandbox explain", "Show effective sandbox config."],
    ["airabot sandbox explain --session agent:main:main", "Explain a specific session."],
    ["airabot sandbox explain --agent work", "Explain an agent sandbox."],
    ["airabot sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.airabot.ai/cli/sandbox")}\n`,
    )
    .action(() => {
