    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["airabot channels list", "List configured channels and auth profiles."],
          ["airabot channels status --probe", "Run channel status checks and probes."],
          [
            "airabot channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["airabot channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.airabot.ai/cli/channels",
        )}\n`,
    );
