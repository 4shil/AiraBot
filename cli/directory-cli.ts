    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["airabot directory self --channel slack", "Show the connected account identity."],
          [
            'airabot directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["airabot directory groups list --channel discord", "List available groups/channels."],
          [
            "airabot directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.airabot.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
