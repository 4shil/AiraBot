...
function mergeSignalAccountConfig(cfg: AiraBotConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: AiraBotConfig): ResolvedSignalAccount[] {
