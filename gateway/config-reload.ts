...
import type { AiraBotConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: AiraBotConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: AiraBotConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: AiraBotConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: AiraBotConfig) => void;
  log: {
