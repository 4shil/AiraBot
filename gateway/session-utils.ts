...
import { type AiraBotConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: AiraBotConfig): string[] {
...
export function listAgentsForGateway(cfg: AiraBotConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: AiraBotConfig): string {
...
function resolveSessionStoreAgentId(cfg: AiraBotConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: AiraBotConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: AiraBotConfig): GatewaySessionsDefaults {
