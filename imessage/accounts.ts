...
function mergeIMessageAccountConfig(cfg: AiraBotConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: AiraBotConfig): ResolvedIMessageAccount[] {
