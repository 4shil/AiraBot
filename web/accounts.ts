...
export function listWhatsAppAuthDirs(cfg: AiraBotConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: AiraBotConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: AiraBotConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: AiraBotConfig): ResolvedWhatsAppAccount[] {
