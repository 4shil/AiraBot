...
export function applyVercelAiGatewayProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyVercelAiGatewayConfig(cfg: AiraBotConfig): AiraBotConfig {
