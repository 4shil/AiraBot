...
export async function statusCommand(
  ...
  runtime.log(theme.heading("AiraBot status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("airabot security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("airabot security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.airabot.ai/faq");
  runtime.log("Troubleshooting: https://docs.airabot.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("airabot status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("airabot logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("airabot status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("airabot gateway probe")}`);
  }
}
