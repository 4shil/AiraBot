...
function resolveDefaultAccountId(cfg: AiraBotConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: AiraBotConfig): boolean {
...
export function summarizeBindings(cfg: AiraBotConfig, bindings: AgentBinding[]): string[] {
