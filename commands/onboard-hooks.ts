...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.airabot.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("airabot hooks list")}`,
      `  ${formatCliCommand("airabot hooks enable <name>")}`,
      `  ${formatCliCommand("airabot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
