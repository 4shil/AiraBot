...
export function applyOpenrouterProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: AiraBotConfig): AiraBotConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyMoonshotConfig(cfg: AiraBotConfig): AiraBotConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: AiraBotConfig): AiraBotConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: AiraBotConfig): AiraBotConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: AiraBotConfig): AiraBotConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: AiraBotConfig): AiraBotConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: AiraBotConfig): AiraBotConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: AiraBotConfig): AiraBotConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: AiraBotConfig): AiraBotConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: AiraBotConfig): AiraBotConfig {
...
export function applyQianfanProviderConfig(cfg: AiraBotConfig): AiraBotConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: AiraBotConfig): AiraBotConfig {
