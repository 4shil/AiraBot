...
type PromptDefaultModelResult = { model?: string; config?: AiraBotConfig };
...
function resolveConfiguredModelRaw(cfg: AiraBotConfig): string {
...
function resolveConfiguredModelKeys(cfg: AiraBotConfig): string[] {
...
export function applyPrimaryModel(cfg: AiraBotConfig, model: string): AiraBotConfig {
...
export function applyModelAllowlist(cfg: AiraBotConfig, models: string[]): AiraBotConfig {
  const defaults = cfg.agents?.defaults;
