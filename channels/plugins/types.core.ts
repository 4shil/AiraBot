...
export type ChannelAgentToolFactory = (params: { cfg?: AiraBotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: AiraBotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: AiraBotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: AiraBotConfig }) => boolean;
  supportsCards?: (params: { cfg: AiraBotConfig }) => boolean;
