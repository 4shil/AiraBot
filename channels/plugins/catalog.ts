...
import { discoverAiraBotPlugins } from "../../plugins/discovery.js";
import type { AiraBotPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, AiraBotPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["AIRABOT_PLUGIN_CATALOG_PATHS", "AIRABOT_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<AiraBotPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: AiraBotPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: AiraBotPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverAiraBotPlugins({ workspaceDir: options.workspaceDir });
