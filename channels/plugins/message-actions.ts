...
export function listChannelMessageActions(cfg: AiraBotConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: AiraBotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: AiraBotConfig): boolean {
  for (const plugin of listChannelPlugins()) {
