...
function mergeDiscordAccountConfig(cfg: AiraBotConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: AiraBotConfig): ResolvedDiscordAccount[] {
