...
const resolveStorePath = vi.fn(() => "/tmp/airabot-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/airabot-discord-process-test-sessions.json");
});
